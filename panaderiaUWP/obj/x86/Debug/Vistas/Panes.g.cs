...
namespace panaderiaUWP.Vistas
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj8_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::panaderiaUWP.Modelos.Pans dataRoot;
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 8: // Vistas\Panes.xaml line 47
                        this.obj8 = new global::System.WeakReference((global::Windows.UI.Xaml.Controls.StackPanel)target);
                        break;
                    case 9: // Vistas\Panes.xaml line 48
                        this.obj9 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 10: // Vistas\Panes.xaml line 49
                        this.obj10 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 11: // Vistas\Panes.xaml line 50
                        this.obj11 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 12: // Vistas\Panes.xaml line 51
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::panaderiaUWP.Modelos.Pans) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::panaderiaUWP.Modelos.Pans)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::panaderiaUWP.Modelos.Pans obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_PanID(obj.PanID, phase);
                        this.Update_NombrePan(obj.NombrePan, phase);
                        this.Update_Cantidad(obj.Cantidad, phase);
                        this.Update_Precio(obj.Precio, phase);
                    }
                }
            }
            private void Update_PanID(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Vistas\Panes.xaml line 48
            ...
            private void Update_NombrePan(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Vistas\Panes.xaml line 49
            ...
            private void Update_Precio(global::System.Decimal obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Vistas\Panes.xaml line 51
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 5: // Vistas\Panes.xaml line 32
                ...
                break;
            case 13: // Vistas\Panes.xaml line 63
                {
